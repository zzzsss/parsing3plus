...
inline long get_index2_o3g(int len,int g,int h,int c,int m)
{
...
extern vector<int>* decodeProjective_o3g(int length,OneScores<REAL_SCORES>& scores);	//only one class
extern REAL_SCORES* LencodeMarginals_o3g(const int length,Scores<REAL_SCORES>& scores);	//same as the ones in scores
