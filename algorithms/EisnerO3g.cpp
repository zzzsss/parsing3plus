...
vector<int>* decodeProjective_o3g(int length,OneScores<REAL_SCORES>& scores)
{
	// the tables
	...
	for(int k=1; k<length; k++){
		...
		for(int s=0; s<length; s++){
			...
			for(int g=0;g<length;g++){
				...
				split_point = -2;
				for(int r = s; r < t; r++){
					REAL_SCORES tmp = scores_table[get_index_o3g(length,g,s,r,E_COM_O3g)]
				...
				//others
				for(int r=s+1;r<t;r++){
					REAL_SCORES tmp = scores_table[get_index_o3g(length,t,s,r,E_SIB_O3g)]
				...
				//others
				for(int r=s+1;r<t;r++){
					REAL_SCORES tmp = scores_table[get_index_o3g(length,s,r,t,E_SIB_O3g)]
				...
				split_point = -2;
				for(int r = s; r < t; r++){
					REAL_SCORES tmp = scores_table[get_index_o3g(length,t,r,s,E_COM_O3g)]
					                          +scores_table[get_index_o3g(length,g,t,r,E_INCOM_O3g)];
					if(tmp >= max_score){
						max_score = tmp;
						split_point = r;
				...
				split_point = -2;
				for(int r = s+1; r <= t; r++){
					REAL_SCORES tmp = scores_table[get_index_o3g(length,g,s,r,E_INCOM_O3g)]
