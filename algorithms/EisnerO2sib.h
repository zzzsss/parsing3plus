...
extern vector<int>* decodeProjective_o2sib(int length,OneScores<REAL_SCORES>& scores);	//only one class
extern REAL_SCORES* LencodeMarginals_o2sib(const int length,Scores<REAL_SCORES>& scores);	//same as the ones in scores
